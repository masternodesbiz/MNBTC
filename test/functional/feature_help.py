...
"""Verify that starting mnbtc with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mnbtc with -? for help text")
        ...
        self.log.info("Start mnbtc with -version for version information")
