...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected mnbtc and zmnbtc supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zmnbtcsupply']:
                assert_equal(node['zmnbtcsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check mnbtc and zmnbtc supply at the beginning
        # ------------------------------------------
        # zmnbtc supply: 2 coins for each denomination
        ...
        # mnbtc supply: block rewards minus burned fees for minting
        ...
        # Verify that mnbtc and zmnbtc supplies were properly updated after the spends and reorgs
        self.log.info("Check mnbtc and zmnbtc supply...")
