Contributing to mnbtc Core
============================

The mnbtc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the mnbtc Core project, and is not to be
confused with overall mnbtc Network Protocol consensus changes.

Whether a pull request is merged into mnbtc Core rests with the project merge
...
Patches that change mnbtc consensus rules are considerably more involved than
...
Where a patchset proposes to change the mnbtc consensus, it must have been
...
The project leader is the release manager for each mnbtc Core release.
