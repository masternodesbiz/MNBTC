...
/** Utility functions used by the mnbtc Qt UI.
 */
namespace GUIUtil
{
...
// Render mnbtc addresses in monospace font
...
// Parse "mnbtc:" URI into recipient object, return true on successful parsing
