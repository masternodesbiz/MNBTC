...
/* mnbtc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "mnbtc"
#define QAPP_ORG_DOMAIN "mnbtc.org"
#define QAPP_APP_NAME_DEFAULT "mnbtc-Qt"
#define QAPP_APP_NAME_TESTNET "mnbtc-Qt-testnet"
