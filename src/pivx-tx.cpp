...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("mnbtc mnbtc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnbtc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnbtc transaction") + "\n" +
                               "  mnbtc-tx [options] -create [commands]   " + _("Create hex-encoded mnbtc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnbtc transaction
