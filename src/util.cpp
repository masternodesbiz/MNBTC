...
const char * const PIVX_CONF_FILENAME = "mnbtc.conf";
const char * const PIVX_PID_FILENAME = "mnbtc.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\mnbtc
// Windows >= Vista: C:\Users\Username\AppData\Roaming\mnbtc
// Mac: ~/Library/Application Support/mnbtc
// Unix: ~/.mnbtc
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "mnbtc";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty mnbtc.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=15223\naddnode=seed1.mn-btc.com:15224\naddnode=seed2.mn-btc.com:15224\naddnode=seed3.mn-btc.com:15224\naddnode=seed4.mn-btc.com:15224\naddnode=seed5.mn-btc.com:15224\naddnode=seed6.mn-btc.com:15224\naddnode=seed7.mn-btc.com:15224\naddnode=seed8.mn-btc.com:15224\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override mnbtc.conf
