...
{
	if (nHeight >   6930000) return     0.00000000 * COIN;
	if (nHeight >   6720000) return     0.00000001 * COIN;
	if (nHeight >   6510000) return     0.00000002 * COIN;
	if (nHeight >   6300000) return     0.00000004 * COIN;
	if (nHeight >   6090000) return     0.00000009 * COIN;
	if (nHeight >   5880000) return     0.00000018 * COIN;
	if (nHeight >   5670000) return     0.00000037 * COIN;
	if (nHeight >   5460000) return     0.00000074 * COIN;
	if (nHeight >   5250000) return     0.00000149 * COIN;
	if (nHeight >   5040000) return     0.00000298 * COIN;
	if (nHeight >   4830000) return     0.00000596 * COIN;
	if (nHeight >   4620000) return     0.00001192 * COIN;
    if (nHeight >   4410000) return     0.00002384 * COIN;
    if (nHeight >   4200000) return     0.00004768 * COIN;
    if (nHeight >   3990000) return     0.00009536 * COIN;
    if (nHeight >   3780000) return     0.00019073 * COIN;
    if (nHeight >   3570000) return     0.00038146 * COIN;
    if (nHeight >   3360000) return     0.00076293 * COIN;
    if (nHeight >   3150000) return     0.00152587 * COIN;
    if (nHeight >   2940000) return     0.00305175 * COIN;
    if (nHeight >   2730000) return     0.00610351 * COIN;
    if (nHeight >   2520000) return     0.01220703 * COIN;
    if (nHeight >   2310000) return     0.02441406 * COIN;
    if (nHeight >   2100000) return     0.04882812 * COIN;
    if (nHeight >   1890000) return     0.09765625 * COIN;
    if (nHeight >   1680000) return     0.19531250 * COIN;
    if (nHeight >   1470000) return     0.39062500 * COIN;
    if (nHeight >   1260000) return     0.78125000 * COIN;
    if (nHeight >   1050000) return     1.56250000 * COIN;
    if (nHeight >    840000) return     3.125   * COIN;
    if (nHeight >    630000) return     6.25 * COIN;
    if (nHeight >    420000) return    12.5 * COIN;
    if (nHeight >    210000) return    25 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 mnbtc tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 mnbtc tx -> 1 confirmation
