...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* mnbtc features */
        {"mnbtc", "listmasternodes", &listmasternodes, true },
        {"mnbtc", "getmasternodecount", &getmasternodecount, true },
        {"mnbtc", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"mnbtc", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"mnbtc", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"mnbtc", "masternodecurrent", &masternodecurrent, true },
        {"mnbtc", "startmasternode", &startmasternode, true },
        {"mnbtc", "createmasternodekey", &createmasternodekey, true },
        {"mnbtc", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"mnbtc", "listmasternodeconf", &listmasternodeconf, true },
        {"mnbtc", "getmasternodestatus", &getmasternodestatus, true },
        {"mnbtc", "getmasternodewinners", &getmasternodewinners, true },
        {"mnbtc", "getmasternodescores", &getmasternodescores, true },
        {"mnbtc", "mnsync", &mnsync, true },
        {"mnbtc", "spork", &spork, true },
        {"mnbtc", "getcollateral", &getcollateral, true},
...
{
    return "> mnbtc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15223/\n";
}
