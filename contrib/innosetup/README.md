...
* Fill in the following data:
    * Application Name: `mnbtc Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The mnbtc Developers`
    * Application Website: `https://mn-btc.com/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `mnbtc`
* Add application files:
    * Select the file `mnbtc-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `mnbtc-2.0.0-win64-setup.exe`
