...
#define MyAppName "mnbtc Core"
#define MyAppPublisher "2021-2022 The mnbtc Developers"
#define MyAppURL "https://github.com/mnbtc/mnbtc"
#define MyAppExeName "mnbtc-qt.exe"
#define MyAppExtraData "https://github.com/mnbtc/mnbtc/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\mnbtc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\mnbtc\mnbtc-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\mnbtc\mnbtc-Qt,strDataDir|{userappdata}\mnbtc\}');
  Result := True;
end;
